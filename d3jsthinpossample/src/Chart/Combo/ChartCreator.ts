...
export class ChartCreator {
  ...
  private GetRenderSVG() {
    let svgWidth =
      this.size.width + this.size.marginLeft + this.size.marginRight;
    let svgHeight =
      this.size.height + this.size.marginTop + this.size.marginBottom;
    let svg = d3
      .select("#canvas")
      .append("svg")
      .attr("width", svgWidth)
  ...
  private DrawYScaleRight2(
    ...
    let drawg = g
      ...
      .attr("class", "axis axis--y")
      .attr("transform", "translate(" + xposition + "," + yposition + ")")
      .call(d3.axisRight(yScale).ticks(10).tickSize(0));
    drawg.selectAll(".domain").style("color", "transparent");
  }
  ...
  private DrawTitle(g: any) {
    ...
    legendG
      ...
      .attr(
        "transform",
        "translate(" +
          -this.size.marginLeft / 2 +
          "," +
          -this.size.marginTop / 1.3 +
          ")"
      )
    ...
    legendG
      ...
      .attr(
        "transform",
        "translate(" + -this.size.marginLeft / 2 + "," + -25 + ")"
      )
      .attr("font-family", "Noto Sans JP")
      .attr("font-size", "14px")
    ...
    legendG
      ...
      .attr(
        "transform",
        "translate(" + -this.size.marginLeft / 2 + "," + -20 + ")"
      )
      .attr("width", 90)
      .attr("height", 10)
  ...
  DrawChart() {
    ...
    //グラフ描画の取得
    let bar = g.selectAll("rect").data(this.dataset).enter().append("g");
